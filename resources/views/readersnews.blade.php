...
<div class="col-md-9">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a id="anchor" href="{{ url('readers-forum')}}"><small>Readers Forum</small></a></li>
...
<div class="container my-4">
  ...
  <img src="{{asset ('public/uploads/images/readers')}}/{{$as->image}}" class="card-img-top" alt="">
