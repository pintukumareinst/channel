...
<div class="col-md-9">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><small>{{$region}}</small></li>
  </ol>
</nav>
...
<div class="container">
  ...
  <h4 class="display-6" style="color: grey;">{{$region}} News</h4>
...
$date=strtotime($date);
 ...
 @endphp
    ...
    <div class="col">
        ...
        <div class="card">
        <a href="{{ url('news')}}/{{$as->slug}}" id="anchor">
